...
MODELS = {
    'PointPillars (KITTI)': {
        'pred_file': 'outputs/kitti_pointpillars_gpu/000010_predictions.json',
    ...
    'PointPillars (nuScenes)': {
        'pred_file': 'outputs/nuscenes_pointpillars/sample2.pcd_predictions.json',
        ...
        'dataset': 'any',
        'input_path': 'data/nuscenes_demo/lidar/sample2.pcd.bin',
        'frame': None,
        'device': 'cuda:0'
    },
    '3DSSD (KITTI)': {
        'pred_file': 'outputs/3dssd/000010_predictions.json',
    ...
    'CenterPoint (nuScenes)': {
        'pred_file': 'outputs/nuscenes_centerpoint/sample2.pcd_predictions.json',
